...
export async function POST(req: Request) {
  ...
  const game = new Game({ _id: gameId, mapType: body.mapType ?? 'classic', settings: { maxVictoryPoints: body.maxVictoryPoints ?? 10, maxPlayers: body.maxPlayers ?? 4 }, phase: 'lobby', setupStep: 'place_settlement', currentPlayerId: null, tiles: [], players: [], nodes: [], edges: [], log: [], chat: [] })
