...
export function Army(props: IconProps) { }

export function LargestArmyIcon(props: IconProps) {
  return (
    <Base {...props} title={props.title ?? 'Legnagyobb hadsereg'} fill='none' stroke='currentColor'>
...
export function LongestRoadIcon(props: IconProps) {
  return (
    <Base {...props} title={props.title ?? 'Leghosszabb út'} fill='none' stroke='currentColor'>
